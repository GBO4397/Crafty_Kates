...
const PostsSection: React.FC = () => {
  ...
  return (
    <section id="posts" className="py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-white via-[#FEF7FB] to-white">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="relative overflow-hidden">
                  <img
                    src={imgError ? '/images/site/2024_03_Classic_Cars_Classic_Burgers-100-14.jpeg' : featuredPost.image}
              ...
              >
                <div className="relative overflow-hidden">
                  <img
                    ...
                    onError={(e) => { (e.target as HTMLImageElement).src = '/images/site/2024_03_Classic_Cars_Classic_Burgers-100-14.jpeg'; }}
                  />
